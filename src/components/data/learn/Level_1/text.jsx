...
function Text({handleStyleOptionClick, selectedStyle}) {  
	...
	return (
		<>
			...
			<p>Try setting <InlineClicker thisStyle={style_1} selectedStyle={selectedStyle} i="1.1" handleClick={handleStyleOptionClick}>'display: flex;'</InlineClicker> on item_2 to turn it into a flex container.</p>
